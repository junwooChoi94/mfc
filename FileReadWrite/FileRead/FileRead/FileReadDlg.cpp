...
CFileReadDlg::CFileReadDlg(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_FILEREAD_DIALOG, pParent)
{
...
BEGIN_MESSAGE_MAP(CFileReadDlg, CDialogEx)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDOK, &CFileReadDlg::OnBnClickedOk)
	ON_BN_CLICKED(IDC_BUTTON1, &CFileReadDlg::OnBnClickedButton1)
	ON_CBN_SELCHANGE(IDC_COMBO1, &CFileReadDlg::OnCbnSelchangeCombo1)
	ON_EN_CHANGE(IDC_EDIT1, &CFileReadDlg::OnEnChangeEdit1)
END_MESSAGE_MAP()
...
void CFileReadDlg::OnCbnSelchangeCombo1()
{
	// TODO: Add your control notification handler code here
}


void CFileReadDlg::OnEnChangeEdit1()
{
